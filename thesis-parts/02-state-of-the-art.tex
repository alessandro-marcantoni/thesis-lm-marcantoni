...
In this section, we will provide a brief overview of the main concepts and characteristics of MAS, as well as the main approaches to their design.
...
All of the above structures come with their benefits and drawbacks, which are briefly summarized in~\ref{table:orgs-advantages-disadvantages} and it is generally agreed that there is no single type of organization that is suitable for all situations.
